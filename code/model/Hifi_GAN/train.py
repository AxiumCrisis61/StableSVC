...
def train(rank, a, h):
    ...
    trainset = MelDataset(training_filelist, 'train', h.segment_size, h.n_fft, h.num_mels,
    ...
    if rank == 0:
        validset = MelDataset(validation_filelist, 'val', h.segment_size, h.n_fft, h.num_mels,
