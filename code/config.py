...
CHANNELS_MULT_FACTORS = (2, 4, 4, 4)            # from official DDPM, (320, 640, 1280, 1280) channels for 'AUDIT'
SHAPE_CHANGE = (True, True, False, False)       # whether to change the shape of feature maps in down/up blocks
